...
const feeOptions: Partial<Record<PlatformType, FeeOption[]>> = {
  ...
  LONGBRIDGE: [{ id: 'longbridge_public_promo', label: '公开活动价', description: '按长桥官网当前公开活动价估算。' }],
  HSBC: [
  ...
  ZHUORUI: [
    { id: 'zhuorui_new_customer', label: '2025 新客费率', description: '适合 2025-03-19 起的新客户。' },
